...
my_ggsave("Figures/FIRE-peaks-percent-fire-vs-DNase.pdf", height=2, width=6)
```
...
my_ggsave("Figures/FIRE-peaks-percent-fire-vs-ATAC.pdf", height=2, width=6)
```
